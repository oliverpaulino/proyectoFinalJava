...
public class RegPC extends JDialog {
	...
	public RegPC(Computadora pc) {
		...
		JLabel label_3 = new JLabel("No seleccionado(s)...");
		label_3.setForeground(Color.RED);
		label_3.setBounds(80, 150, 127, 16);
		panel_1.add(label_3);
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						if (pc == null) {
							...
							/*
							 * private ArrayList<String> selectedMotherboardsId; private ArrayList<String>
							 * selectedRAMsId; private ArrayList<String> selectedHardDrivesId; private
							 * ArrayList<String> selectedProcesadoresId;
							 * 
							 */
						}
